  ...
  public: {
    Tables: {
      ...
      live_match_state: {
        ...
        Relationships: [
          {
            foreignKeyName: "live_match_state_current_bowler_id_fkey"
          ...
          {
            foreignKeyName: "live_match_state_current_non_striker_id_fkey"
          ...
          {
            foreignKeyName: "live_match_state_current_striker_id_fkey"
          ...
          {
            foreignKeyName: "live_match_state_match_id_fkey"
            columns: ["match_id"]
            isOneToOne: true
            referencedRelation: "matches"
            referencedColumns: ["id"]
